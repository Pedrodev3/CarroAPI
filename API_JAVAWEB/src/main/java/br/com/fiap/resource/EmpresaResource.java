...
public class EmpresaResource {
	...
	public Response loginUsuario(EmpresaTO et) throws SQLException {
	...
	@POST
	@Consumes(MediaType.APPLICATION_JSON)
	public Response cadastrar(EmpresaTO et, @Context UriInfo uriInfo) throws SQLException {
	...
	@Path("/{id}")
	@Consumes(MediaType.APPLICATION_JSON)
	public Response atualizar(EmpresaTO et, @PathParam("id") int id) throws SQLException {
	...
	@Path("/{id}")
	@Produces(MediaType.APPLICATION_JSON)
	public List<EmpresaTO> buscar(@PathParam("id") int id) throws SQLException {
		return eb.listar(id);
	}
	...
	@GET
	@Produces(MediaType.APPLICATION_JSON)
	public List<EmpresaTO> buscarTodos() throws SQLException {
